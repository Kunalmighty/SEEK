...
namespace SEEK.Pages
{
    ...
    /// </summary>
    public sealed partial class NewReleasePhone : Page
    {
        public NewReleasePhone()
        {
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            String[] QuesStr2 =
                Windows.Storage.ApplicationData.Current.LocalSettings.Values["CurrItem3"].ToString().Split('ɦ');
        ...
        {
            Frame.Navigate(typeof (NewReleases));
        }
    }
}
